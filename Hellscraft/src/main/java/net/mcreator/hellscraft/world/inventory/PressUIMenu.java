...
public class PressUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PressUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HellscraftModMenus.PRESS_UI.get(), id);
