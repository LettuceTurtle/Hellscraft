...
public class LevitationPotionRecipeBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> BrewingRecipeRegistry.addRecipe(new LevitationPotionRecipeBrewingRecipe()));
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionUtils.setPotion(new ItemStack(input.getItem()), HellscraftModPotions.LEVITATION.get());
		}
