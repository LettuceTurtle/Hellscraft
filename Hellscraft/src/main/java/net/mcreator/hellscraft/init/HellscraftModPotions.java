...
public class HellscraftModPotions {
	...
	public static final RegistryObject<Potion> HASTE = REGISTRY.register("haste", () -> new Potion(new MobEffectInstance(MobEffects.DIG_SPEED, 3600, 1, false, true)));
	public static final RegistryObject<Potion> ENHANCED_HASTE = REGISTRY.register("enhanced_haste", () -> new Potion(new MobEffectInstance(MobEffects.DIG_SPEED, 3600, 2, false, true)));
	public static final RegistryObject<Potion> EXTENDED_HASTE = REGISTRY.register("extended_haste", () -> new Potion(new MobEffectInstance(MobEffects.DIG_SPEED, 7200, 1, false, true)));
}
