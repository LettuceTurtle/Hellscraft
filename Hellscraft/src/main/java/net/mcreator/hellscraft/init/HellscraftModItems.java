...
import net.mcreator.hellscraft.item.TotemOfInfusionWeaknessItem;
import net.mcreator.hellscraft.item.TotemOfInfusionWaterbreathingItem;
import net.mcreator.hellscraft.item.TotemOfInfusionStrengthItem;
import net.mcreator.hellscraft.item.TotemOfInfusionSpeedItem;
import net.mcreator.hellscraft.item.TotemOfInfusionSlownessItem;
import net.mcreator.hellscraft.item.TotemOfInfusionSlowfallingItem;
import net.mcreator.hellscraft.item.TotemOfInfusionRegenItem;
import net.mcreator.hellscraft.item.TotemOfInfusionPoisonItem;
import net.mcreator.hellscraft.item.TotemOfInfusionNightvisionItem;
import net.mcreator.hellscraft.item.TotemOfInfusionNauseaItem;
import net.mcreator.hellscraft.item.TotemOfInfusionLevitationItem;
import net.mcreator.hellscraft.item.TotemOfInfusionJumpboostItem;
import net.mcreator.hellscraft.item.TotemOfInfusionItem;
import net.mcreator.hellscraft.item.TotemOfInfusionInvisibilityItem;
import net.mcreator.hellscraft.item.TotemOfInfusionHasteItem;
import net.mcreator.hellscraft.item.TotemOfInfusionFireresistanceItem;
...
public class HellscraftModItems {
	...
	public static final RegistryObject<Item> ENDGRANITE_SLAB = block(HellscraftModBlocks.ENDGRANITE_SLAB);
	public static final RegistryObject<Item> ENDGRANITE_STAIRS = block(HellscraftModBlocks.ENDGRANITE_STAIRS);
	public static final RegistryObject<Item> ENDGRANITE_WALL = block(HellscraftModBlocks.ENDGRANITE_WALL);
	public static final RegistryObject<Item> ENDIORITE = block(HellscraftModBlocks.ENDIORITE);
	public static final RegistryObject<Item> ENDIORITE_SLAB = block(HellscraftModBlocks.ENDIORITE_SLAB);
	public static final RegistryObject<Item> ENDIORITE_STAIRS = block(HellscraftModBlocks.ENDIORITE_STAIRS);
	public static final RegistryObject<Item> ENDIORITE_WALL = block(HellscraftModBlocks.ENDIORITE_WALL);
	public static final RegistryObject<Item> ENDERSITE = block(HellscraftModBlocks.ENDERSITE);
	public static final RegistryObject<Item> ENDERSITE_SLAB = block(HellscraftModBlocks.ENDERSITE_SLAB);
	public static final RegistryObject<Item> ENDERSITE_STAIRS = block(HellscraftModBlocks.ENDERSITE_STAIRS);
	public static final RegistryObject<Item> ENDERSITE_WALL = block(HellscraftModBlocks.ENDERSITE_WALL);
	public static final RegistryObject<Item> POLISHED_ENDGRANITE = block(HellscraftModBlocks.POLISHED_ENDGRANITE);
	public static final RegistryObject<Item> POLISHED_ENDGRANITE_SLAB = block(HellscraftModBlocks.POLISHED_ENDGRANITE_SLAB);
	public static final RegistryObject<Item> POLISHED_ENDIORITE = block(HellscraftModBlocks.POLISHED_ENDIORITE);
	public static final RegistryObject<Item> POLISHED_ENDIORITE_SLAB = block(HellscraftModBlocks.POLISHED_ENDIORITE_SLAB);
	public static final RegistryObject<Item> POLISHED_ENDERSITE = block(HellscraftModBlocks.POLISHED_ENDERSITE);
	public static final RegistryObject<Item> POLISHED_ENDERSITE_SLAB = block(HellscraftModBlocks.POLISHED_ENDERSITE_SLAB);
	...
	public static final RegistryObject<Item> KIDNEYSTONE_SLAB = block(HellscraftModBlocks.KIDNEYSTONE_SLAB);
	public static final RegistryObject<Item> KIDNEYSTONE_STAIRS = block(HellscraftModBlocks.KIDNEYSTONE_STAIRS);
	public static final RegistryObject<Item> KIDNEYSTONE_WALL = block(HellscraftModBlocks.KIDNEYSTONE_WALL);
	public static final RegistryObject<Item> POLISHED_KIDNEYSTONE_SLAB = block(HellscraftModBlocks.POLISHED_KIDNEYSTONE_SLAB);
	public static final RegistryObject<Item> KIDNEYSTONE_BRICK_SLAB = block(HellscraftModBlocks.KIDNEYSTONE_BRICK_SLAB);
	public static final RegistryObject<Item> KIDNEYSTONE_BRICK_STAIRS = block(HellscraftModBlocks.KIDNEYSTONE_BRICK_STAIRS);
	public static final RegistryObject<Item> KIDNEYSTONE_BRICK_WALL = block(HellscraftModBlocks.KIDNEYSTONE_BRICK_WALL);
	public static final RegistryObject<Item> CRACKED_KIDNEYSTONE_BRICK_SLAB = block(HellscraftModBlocks.CRACKED_KIDNEYSTONE_BRICK_SLAB);
	public static final RegistryObject<Item> BLOCK_OF_URANIUM = block(HellscraftModBlocks.BLOCK_OF_URANIUM);
	public static final RegistryObject<Item> BLOCK_OF_RAW_LEAD = block(HellscraftModBlocks.BLOCK_OF_RAW_LEAD);
	public static final RegistryObject<Item> DEEPERSLATE_SLAB = block(HellscraftModBlocks.DEEPERSLATE_SLAB);
	public static final RegistryObject<Item> DEEPERSLATE_STAIRS = block(HellscraftModBlocks.DEEPERSLATE_STAIRS);
	public static final RegistryObject<Item> DEEPERSLATE_WALL = block(HellscraftModBlocks.DEEPERSLATE_WALL);
	public static final RegistryObject<Item> JEWELED_DEEPERSLATE_SLAB = block(HellscraftModBlocks.JEWELED_DEEPERSLATE_SLAB);
	public static final RegistryObject<Item> GILDED_DEEPERSLATE_SLAB = block(HellscraftModBlocks.GILDED_DEEPERSLATE_SLAB);
	public static final RegistryObject<Item> GALVANIC_DEEPERSLATE_SLAB = block(HellscraftModBlocks.GALVANIC_DEEPERSLATE_SLAB);
	public static final RegistryObject<Item> TOTEM_OF_INFUSION = REGISTRY.register("totem_of_infusion", () -> new TotemOfInfusionItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_SPEED = REGISTRY.register("totem_of_infusion_speed", () -> new TotemOfInfusionSpeedItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_SLOWNESS = REGISTRY.register("totem_of_infusion_slowness", () -> new TotemOfInfusionSlownessItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_JUMPBOOST = REGISTRY.register("totem_of_infusion_jumpboost", () -> new TotemOfInfusionJumpboostItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_STRENGTH = REGISTRY.register("totem_of_infusion_strength", () -> new TotemOfInfusionStrengthItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_WEAKNESS = REGISTRY.register("totem_of_infusion_weakness", () -> new TotemOfInfusionWeaknessItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_POISON = REGISTRY.register("totem_of_infusion_poison", () -> new TotemOfInfusionPoisonItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_REGEN = REGISTRY.register("totem_of_infusion_regen", () -> new TotemOfInfusionRegenItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_FIRERESISTANCE = REGISTRY.register("totem_of_infusion_fireresistance", () -> new TotemOfInfusionFireresistanceItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_WATERBREATHING = REGISTRY.register("totem_of_infusion_waterbreathing", () -> new TotemOfInfusionWaterbreathingItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_NIGHTVISION = REGISTRY.register("totem_of_infusion_nightvision", () -> new TotemOfInfusionNightvisionItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_INVISIBILITY = REGISTRY.register("totem_of_infusion_invisibility", () -> new TotemOfInfusionInvisibilityItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_SLOWFALLING = REGISTRY.register("totem_of_infusion_slowfalling", () -> new TotemOfInfusionSlowfallingItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_NAUSEA = REGISTRY.register("totem_of_infusion_nausea", () -> new TotemOfInfusionNauseaItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_LEVITATION = REGISTRY.register("totem_of_infusion_levitation", () -> new TotemOfInfusionLevitationItem());
	public static final RegistryObject<Item> TOTEM_OF_INFUSION_HASTE = REGISTRY.register("totem_of_infusion_haste", () -> new TotemOfInfusionHasteItem());
